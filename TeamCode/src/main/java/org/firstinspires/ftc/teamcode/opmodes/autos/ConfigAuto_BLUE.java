...
@Autonomous(name = "ConfigAuto BLUE", group = "Autonomous")
@Configurable // Panels
public class ConfigAuto_BLUE extends LinearOpMode {
    ...
    private double targetTurretAngle = 45;  // Default angle for BLUE
    ...
    private final Pose2D startPose = new Pose2D(DistanceUnit.INCH, 33, 135, AngleUnit.RADIANS, Math.toRadians(-90));
...
//                    )
            ...
            Tape2ToSHoot2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(25.000, 60), new Pose(57.000, 73.000))
                    )
                    .setTangentHeadingInterpolation()
                    .setReversed()
                    .build();
            ...
            Shoot2ToLever = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(57.000, 73.000), new Pose(37.750, 64)) //64
                    )
            ...
            LeverToShoot3 = follower
                    ...
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(9, 64), new Pose(57.000, 73.000))
                    )
...
//                    )
            ...
            Suicide = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(46, 85), new Pose(16, 16))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
    ...
    public void setPathState(State state) {
        ...
        switch (state) {
            ...
            case StartToShoot:
                ...
                // Calculated: pos(49,88), heading -71°, goal(6,143.5) → turret 199°
                targetTurretAngle = 199;
                shooterRunning = true;
            ...
            case GoToShooting2:
                ...
                // Calculated: pos(57,73), heading -158°, goal(6,143.5) → turret 284°
                targetTurretAngle = 284;
                shooterRunning = true;
            ...
            case ShootLever:
                ...
                // Calculated: pos(57,73), heading -171°, goal(6,143.5) → turret 296°
                targetTurretAngle = 296;
                shooterRunning = true;
            ...
            case Tape1Shoot:
                ...
                // Calculated: pos(46,85), heading -178°, goal(6,143.5) → turret 303°
                targetTurretAngle = 303;
                shooter.stopIntakeSystem();
                shooterRunning = true;
            ...
            case CornerToShoot:
                ...
                // Calculated: pos(57,75), heading -137°, goal(6,143.5) → turret 263°
                targetTurretAngle = 263;
                shooter.stopIntakeSystem();
                shooterRunning = true;
            ...
            case SuicideToShoot:
                ...
                // Calculated: pos(57,75), heading -125°, goal(6,143.5) → turret 252°
                targetTurretAngle = 252;
                shooter.stopIntakeSystem();
                shooterRunning = true;
        ...
        switch (state) {
            ...
            case Shooting:
                ...
                if(!atShot) {
                    ...
                    if(shooting) {
                        boolean isAligned = shooter.isTurretAligned(false);  // false = BLUE alliance
                        ...
                        if(shooterSpeedReady && (isAligned || timedOut)) {
                            shooter.unblockShooter();
                            shooter.runIntakeSystem(-(RobotConstants.INTAKE_POWER));  // Negative to feed balls
                            shootTimer.reset();
                            shooting = false;
                        }
                    } else {
